...
const compilations = [
	...
	// Capybara extensions
	'extensions/capybara-defaults/tsconfig.json',
	'extensions/capybara-agent/tsconfig.json',
];
...
/**
 * Copy Claude Code extension to build directory
 */
const copyClaudeCodeExtensionTask = task.define('copy-claude-code-extension', () => {
	return gulp.src('extensions/.claude-code/**/*')
		.pipe(gulp.dest('.build/extensions/claude-code'));
});
