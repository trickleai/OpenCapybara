...
const LayoutStateKeys = {
	...
	AUXILIARYBAR_SIZE: new InitializationStateKey<number>('auxiliaryBar.size', StorageScope.PROFILE, StorageTarget.MACHINE, 450),
	...
	AUXILIARYBAR_LAST_NON_MAXIMIZED_SIZE: new RuntimeStateKey<number>('auxiliaryBar.lastNonMaximizedSize', StorageScope.PROFILE, StorageTarget.MACHINE, 450),
...
class LayoutStateModel extends Disposable {
	...
	load(configuration: ILayoutStateLoadConfiguration): void {
		...
		LayoutStateKeys.AUXILIARYBAR_SIZE.defaultValue = Math.min(450, mainContainerDimension.width / 4);
