...
const DISCLAIMER = localize('chatDisclaimer', "Your AI-powered knowledge assistant");
	...
	*/
	...
	private getWelcomeViewContent(additionalMessage: string | IMarkdownString | undefined): IChatViewWelcomeContent {
		...
		if (this.input.currentModeKind === ChatModeKind.Ask) {
			title = localize('chatDescription', "Ask anything");
		} else if (this.input.currentModeKind === ChatModeKind.Edit) {
			title = localize('editsTitle', "Edit your content");
		} else {
			title = localize('agentTitle', "Create with Capybara");
		}
