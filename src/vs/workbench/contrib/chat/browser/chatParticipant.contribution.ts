...
// Capybara: Commented out unused imports after disabling Chat view
...
// Capybara: Disabled VSCode native Chat view to avoid conflict with Session Dashboard
// Capybara uses Claude Code as the primary AI interface, not VSCode's built-in Chat
